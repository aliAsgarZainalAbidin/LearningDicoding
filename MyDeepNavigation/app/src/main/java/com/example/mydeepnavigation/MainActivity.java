...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AsynCallback {
    ...
    private static class DelayAsync extends AsyncTask<Void, Void, Void>{
        WeakReference<AsynCallback> callback;
        DelayAsync(AsynCallback callback){
